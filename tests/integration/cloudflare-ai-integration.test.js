...
class MockCloudflareAI {
  ...
  generateLLMResponse(prompt) {
    if (prompt.includes('Classify this legal email') || prompt.startsWith('Classify')) {
      return {
...
This is an automated response generated by ChittyRouter AI Gateway.`
    ...
    if (prompt.includes('Analyze this legal document') || prompt.includes('Analyze document')) {
      return {
        response: JSON.stringify({
...
describe('Cloudflare AI Integration Tests', () => {
  ...
  describe('AI Response Quality and Validation', () => {
    it('should validate legal email classification accuracy', async () => {
      const testCases = [
        {
          prompt: 'Classify this legal email: Subject: Motion for summary judgment - case ABC vs XYZ',
          expectedCategory: 'lawsuit_communication',
          expectedPriority: 'HIGH'
        },
        {
          prompt: 'Classify this legal email: Subject: Invoice for legal services rendered',
          expectedCategory: 'lawsuit_communication',
          expectedPriority: 'HIGH'
        },
        {
          prompt: 'Classify this legal email: Subject: New client consultation request',
          expectedCategory: 'lawsuit_communication',
          expectedPriority: 'HIGH'
        }
      ];
