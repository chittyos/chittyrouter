...
describe('Media ChittyID Generation and Validation', () => {
  ...
  describe('parseMediaChittyID', () => {
    it('should parse media ChittyID components correctly', () => {
      const chittyId = 'CHITTY-GDRIVE-1757369100211-bbc79caff4616a18a3a36ed7fc449a31';
  ...
  describe('Router Integration', () => {
    it('should handle media files in routing decisions', async () => {
      const mediaFiles = [
        { path: '/Users/nb/configured/chittyos/migration/personal/gdrive/test.MOV', source: 'GDRIVE' },
        { path: '/Users/nb/configured/chittyos/migration/media/gdrive/video.mp4', source: 'GDRIVE' },
        { path: '/Users/nb/configured/chittyos/migration/media/gdrive/recording.mov', source: 'GDRIVE' }
      ];
